...
#define SCL_DESIRED_FREQ 100000UL //Desired Clcok Frequency
#include <avr/io.h>
#include<stdint.h> 
...
int main(void) {
    ...
    VL6180X_read_addr16_data8(REG_FRESH_OUT_OF_RESET);
...
uint8_t VL6180X_read_addr16_data8(uint16_t address) {
    ...
    I2C_Write((VL6180X_ADDRESS << 1) | 0x53); //SLA + READ (0X53)
